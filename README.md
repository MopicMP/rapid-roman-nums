...
> Rapid convert to/from roman numerals

[![PyPI version](https://badge.fury.io/py/rapid-roman-nums.svg)](https://pypi.org/project/rapid-roman-nums/)
...
```bash
pip install rapid-roman-nums
```

## Quick Start

```python
from rapid_roman_nums import nums
...
from rapid_roman_nums import batch
